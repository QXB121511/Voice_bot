...
model_dir_local = "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/SentenceFinishedClassification"
...
class TurnDetection:
    ...
    def __init__(
        ...
        local: bool = False,
        pipeline_latency: float = 0.5, # default=0.5
        pipeline_latency_overhead: float = 0.1, # default=0.1
    ) -> None:
        """
    ...
    def update_settings(self, speed_factor: float) -> None:
        ...
        # fast = {
        #     'detection_speed': 0.05,
        #     'ellipsis_pause': 0.05,
        #     'punctuation_pause': 0.05,
        #     'exclamation_pause': 0.05,
        #     'question_pause': 0.05,
        #     'unknown_sentence_detection_pause': 0.05
        # }
