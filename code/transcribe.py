...
DEFAULT_RECORDER_CONFIG: Dict[str, Any] = {
    ...
    "model": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/faster-whisper-base_en",
    "realtime_model_type": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/faster-whisper-base_en",

    # "model": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/whisper-tiny",
    # "realtime_model_type": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/whisper-tiny",

    # "model": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/faster-whisper-tiny",
    # "realtime_model_type": "/data2/qinxb/AUDIO/RealtimeVoiceChat/models/faster-whisper-tiny",

    "use_main_model_for_realtime": False,
    "language": "en", # Default, will be overridden by source_language in __init__
    "silero_sensitivity": 0.5, # default = 0.05
    "webrtc_sensitivity": 1, # default = 3
    "post_speech_silence_duration": 0.7,#default=0.7,
    "min_length_of_recording": 1, # default=0.5,
    "min_gap_between_recordings": 0,#default=0,
    "enable_realtime_transcription":True, 
    "realtime_processing_pause": 0.03,
    "silero_use_onnx": True,
    "silero_deactivity_detection": True,
    "early_transcription_on_silence": 0.3,#default=0,
    "beam_size": 3,
    ...
    "debug_mode": False,#Default=True,
    "initial_prompt_realtime": "How are you?",
...
class TranscriptionProcessor:
    ...
    _HOT_THRESHOLD_OFFSET_S: float = 0.35 # default = 0.35
    # Minimum duration for the "hot" condition to be meaningful
    _MIN_HOT_CONDITION_DURATION_S: float = 0.15 # default=0.15
    # Time before full silence duration when TTS synthesis might be allowed
    _TTS_ALLOWANCE_OFFSET_S: float = 0.25 # default=0.25
    ...
    def __init__(
            ...
            pipeline_latency: float = 0.05, # default = 0.5
    ...
    def _start_silence_monitor(self) -> None:
        ...
        def monitor():
            ...
            self.silence_time = self._get_recorder_param("speech_end_silence_start", 0.0)  # default=0.0
