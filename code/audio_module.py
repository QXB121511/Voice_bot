...
class AudioProcessor:
    ...
    def __init__(
        ...
        if engine == "coqui":
            ensure_lasinya_models(models_root="/data2/qinxb/AUDIO/RealtimeVoiceChat/models", model_name="XTTS_Lasinya")
            self.engine = CoquiEngine(
                specific_model="Lasinya",
                local_models_path="/data2/qinxb/AUDIO/RealtimeVoiceChat/models",
